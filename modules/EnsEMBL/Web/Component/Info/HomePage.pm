...
my (@sections);
  ...
  <a id="asm-toggle_description"><span class="asm-description" style="cursor:pointer">show</span><span class="asm-description hidden" style="cursor:pointer">hide</span> full description</a></p>
