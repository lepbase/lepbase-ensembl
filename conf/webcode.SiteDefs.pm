...
our $ENSEMBL_VERSION           = $Access::LEPBASE_VERSION;
our $ARCHIVE_VERSION           = $Access::LEPBASE_ARCHIVE;    # Change this to the archive site for this version
our $ENSEMBL_RELEASE_DATE      = $Access::LEPBASE_RELEASE_DATE;
...
our $ENSEMBL_SERVER            = $Access::LEPBASE_SERVER;  # Local machine name
our $ENSEMBL_BLOG_URL          = $Access::LEPBASE_BLOG_URL;
our $ENSEMBL_PORT              = 80;
our $ENSEMBL_PROXY_PORT        = 80; # Port used for self-referential URLs. Set to undef if not using proxy-forwarding
our $ENSEMBL_MIRRORS           = 0;

our $ENSEMBL_SERVERADMIN       = $Access::LEPBASE_SERVERADMIN;
our $ENSEMBL_HELPDESK_EMAIL    = $Access::LEPBASE_HELPDESK_EMAIL;
our $ENSEMBL_MAIL_SERVER       = $Access::LEPBASE_MAIL_SERVER;
our $ENSEMBL_MAIL_USER         = $Access::LEPBASE_MAIL_USER;
our $ENSEMBL_MAIL_PORT         = $Access::LEPBASE_MAIL_PORT;
our $ENSEMBL_MAIL_PASS         = $Access::LEPBASE_MAIL_PASS;
our $ENSEMBL_MAIL_USE_TLS      = $Access::LEPBASE_USE_TLS;
our $ENSEMBL_SERVERNAME        = $Access::LEPBASE_SERVERNAME;
our $ENSEMBL_STATIC_SERVER     = "";
our $ENSEMBL_PROTOCOL          = $Access::LEPBASE_PROTOCOL;
our $ENSEMBL_MAIL_COMMAND      = '/usr/sbin/ssmtp';               # Mail command
our $ENSEMBL_MAIL_ERRORS       = $Access::LEPBASE_MAIL_ERRORS;  # Do we want to email errors?
our $ENSEMBL_ERRORS_TO         = $Access::LEPBASE_ERRORS_TO;    # ...and to whom?
...
our $ENSEMBL_USERDB_NAME      = $Access::LEPBASE_USERDB_NAME;
our $ENSEMBL_USERDB_USER      = $Access::LEPBASE_USERDB_USER;
our $ENSEMBL_USERDB_HOST      = $Access::LEPBASE_USERDB_HOST;
our $ENSEMBL_USERDB_PORT      = $Access::LEPBASE_USERDB_PORT;
our $ENSEMBL_USERDB_PASS      = $Access::LEPBASE_USERDB_PASS;
